          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                github="https://github.com/williamslsy/crypto_screener"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project type="Web3" title="NFT collection Website" img={project2} link="https://github.com/williamslsy/weirdos-nft" github="https://github.com/williamslsy/weirdos-nft" />
            </div>
            <div className="col-span-6 sm:col-span-12">
